...
[![GitHub release](https://img.shields.io/badge/release-1.3.1-blue.svg)](https://github.com/polyv/polyv-harmony-livescenes-sdk-demo/releases/tag/1.3.1)
...
#### 3.2 接口文档
[v1.3.1 接口文档](https://repo.polyv.net/harmony/documents/livescenes_sdk/1.3.1/index.html)
#### 3.3 版本更新记录
