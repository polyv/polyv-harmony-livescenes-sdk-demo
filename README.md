...
[![GitHub release](https://img.shields.io/badge/release-1.3.3-blue.svg)](https://github.com/polyv/polyv-harmony-livescenes-sdk-demo/releases/tag/1.3.3)
...
#### 3.2 接口文档
[v1.3.3 接口文档](https://repo.polyv.net/harmony/documents/livescenes_sdk/1.3.3/index.html)
#### 3.3 版本更新记录
